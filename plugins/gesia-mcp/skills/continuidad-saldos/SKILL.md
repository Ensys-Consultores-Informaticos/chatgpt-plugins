...
Los scripts están en `skills/continuidad-saldos/scripts/`, dentro de la raíz del plugin instalado.
...
Los ficheros que dejes con `exportar_consulta` escríbelos en `<TEMP>/gesia-continuidad` o en el directorio de trabajo, **nunca en la carpeta del expediente**, y bórralos al terminar.
