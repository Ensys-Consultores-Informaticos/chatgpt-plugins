...
Los scripts están en `skills/identificacion-riesgos/scripts/`, dentro de la raíz del plugin instalado.
...
1. **Si el entorno ofrece una herramienta para pedir permiso de borrado**, pídelo
