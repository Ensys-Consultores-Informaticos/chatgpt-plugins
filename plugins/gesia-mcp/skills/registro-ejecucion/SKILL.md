...
—no sobre el cliente— vive solo en la conversación, y la conversación se cierra
y no vuelve. Este skill lo pone por escrito con una estructura fija,
...
medir.** El registro de pasos y de llamadas a herramientas suele venir fechado; de ahí sale cuánto tardó el conjunto y qué paso se llevó la mayor
...
1. **Identificación.** Qué skill se ejecutó y su versión si consta; versión del
   ...
   27/08/2026 convivían dos copias del mismo skill —una de trabajo y la
   publicada— y no se sabía cuál se estaba ejecutando.
...
| El entorno deja marcas de tiempo | se usan: son medición, no estimación. Se dice de dónde salen |
